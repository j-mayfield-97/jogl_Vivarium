...
private GLUT glut;
  ...
  boolean add_food = false;
private int destroy_index = -1;
  ...
  public void display(GLAutoDrawable drawable)
  {
    ...
    vivarium.update( gl );
    vivarium.draw( gl );
    vivarium.add_creature(add_food, gl);
    destroy_index = -1;
    add_food = false;
  }
                            ...
                            int width, int height)
  {
    ...
    // Camera positioned at (0,0,tanksize * 3), look at point (0,0,0), Up Vector (0,1,0)
    //Why is multiplying the size times three make the camera positioned correctly?
    glu.gluLookAt(0, 0, vivarium.TANK_SIZE * 3, 0, 0, 0, 0, 1, 0);
  ...
  public void keyPressed(KeyEvent key)
  {
    switch (key.getKeyCode()) {
      case KeyEvent.VK_ESCAPE:
        ...
        System.exit(0);
        break;
        //control to delete first creature
